...
ოუნერი მხოლოდ მენცართან ლაპარაკობს. ვიქტორთან და გურაფასთან მენცარი კომუნიცირებს.
...
- სესიის დასაწყისი: "დღეს ვწყვეტ [X] პრობლემას" — არა "რა გავაკეთო?"
- Goals, not activity: 10 docs ≠ progress. 1 call = progress. 1 demo = progress.
- Last prompt = 20:00 — სისტემა მუშაობს, ოუნერი ისვენებს
